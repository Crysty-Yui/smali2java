...
.method private static E([B)Ljava/lang/String;
    ...
    .line 144
    :cond_1
    const-string v0, "MicroMsg.BakToPCPacker"

    const-string v3, "dump errBuf: %s"
...
.method public static a([BISSII[BLcom/tencent/mm/pointers/PByteArray;)I
    ...
    .line 84
    const-string v0, "unpack failed, getVersion:%d"
    ...
    .line 85
    const-string v1, "MicroMsg.BakToPCPacker"
    ...
    .line 91
    invoke-static/range {v0 .. v5}, Lcom/tencent/mm/plugin/backup/bakpcmodel/e;->a([BISSI[B)I
    ...
    .line 95
    invoke-static {p6}, Lcom/tencent/mm/plugin/backup/bakpcmodel/e;->E([B)Ljava/lang/String;

    move-result-object v2

    .line 96
    const-string v3, "unpack failed--calcSum:%d, getfromPcMgr:%d, seq:%d, type:%d, size:%d, just buf.crc:%d, last 100 bytes:%s"
    ...
    invoke-static {p6, v0}, Lcom/tencent/mm/a/i;->a([B[B)[B
...
.method private static a([BISSI[B)I
    ...
    .line 124
    invoke-static {p4}, Lcom/tencent/mm/a/j;->bg(I)[B
    ...
    invoke-static {v2}, Lcom/tencent/mm/a/j;->bg(I)[B
...
.method public static a([BISLcom/tencent/mm/pointers/PByteArray;)V
    ...
    invoke-static {v1}, Lcom/tencent/mm/a/j;->bg(I)[B
    ...
    invoke-static {p0, v1}, Lcom/tencent/mm/a/i;->b([B[B)[B
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
