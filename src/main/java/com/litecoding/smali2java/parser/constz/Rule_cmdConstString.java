...
package com.litecoding.smali2java.parser.constz;

import java.util.ArrayList;

import com.litecoding.smali2java.parser.ParserContext;
import com.litecoding.smali2java.parser.Rule;
import com.litecoding.smali2java.parser.Rule_codeRegisterVDst;
import com.litecoding.smali2java.parser.Rule_commentSequence;
import com.litecoding.smali2java.parser.Rule_listSeparator;
...
final public class Rule_cmdConstString extends Rule
{
  ...
  public static Rule_cmdConstString parse(ParserContext context)
  {
	...
	public static void main(String[] args) {
		ParserContext context = new ParserContext("    const-string v0, \"192.168.1.106\"\n", true);
