...
package com.litecoding.smali2java.parser.clazz;

import java.util.ArrayList;

import com.litecoding.smali2java.entity.smali.Rule_dirEndField;
import com.litecoding.smali2java.entity.smali.Rule_dirField;
...
import com.litecoding.smali2java.parser.method.Rule_type;
...
final public class Rule_classField extends Rule
{
  ...
  public static Rule_classField parse(ParserContext context)
  {
	...
	public static void main(String[] args) {
		ParserContext context = new ParserContext(".field private tempJ:I\n", true);
