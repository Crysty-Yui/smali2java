...
package com.litecoding.smali2java.parser.cmd.get7put.iput;
...
final public class Rule_cmdIputObject extends Rule
{
  ...
  public static Rule_cmdIputObject parse(ParserContext context)
  {
	...
	public static void main(String[] args) {
		ParserContext context = new ParserContext("    iput-object v0, p0, Lcom/vanke/OpenDoor/ServiceShake;->dstIp:Ljava/lang/String;\n", true);
