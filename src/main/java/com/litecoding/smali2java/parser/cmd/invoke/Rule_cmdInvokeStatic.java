...
package com.litecoding.smali2java.parser.cmd.invoke;
...
final public class Rule_cmdInvokeStatic extends LineRule {
    ...
    public static void main(String[] args) {
        ParserContext context = new ParserContext("    invoke-static {}, Lcom/itheima/redbaby/util/ThreadPoolManager;->getInstance()Lcom/itheima/redbaby/util/ThreadPoolManager;" + "\n", false);
