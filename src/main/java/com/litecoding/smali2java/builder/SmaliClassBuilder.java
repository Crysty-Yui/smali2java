...
import com.litecoding.smali2java.parser.method.Rule_methodLine;
import com.litecoding.smali2java.parser.method.Rule_methodLocal;
import com.litecoding.smali2java.parser.method.Rule_methodLocals;
import com.litecoding.smali2java.parser.method.Rule_methodParam;
import com.litecoding.smali2java.parser.method.Rule_methodPrologue;
...
public class SmaliClassBuilder extends BasicCommandsBuilder {
	...
	public Object visit(Rule_classMethodProto rule) {
		...
		boolean awaitingReturnType = false;// 返回类型
